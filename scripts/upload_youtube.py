...
video_file = '/Users/smithkwon/.openclaw/workspace/dailypriceup/data/daily_shorts_final.mp4'
...
def upload_video():
    ...
    title = f"({today_str}) 서울/경기 아파트 신고가 랭킹 TOP10 #Shorts"
...
#부동산 #아파트실거래가 #신고가 #강남아파트 #Shorts #부동산전망
...
http://creativecommons.org/licenses/by/4.0/"""
    ...
    body = {
        'snippet': {
            ...
            'tags': ['부동산', '아파트', '실거래가', '강남', '서초', '송파', '신고가', 'shorts'],
